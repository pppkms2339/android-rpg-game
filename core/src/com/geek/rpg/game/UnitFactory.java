...
import com.geek.rpg.game.actions.ArrowAction;
...
public class UnitFactory {
    ...
    public void createActions() {
        ...
        this.actions.add(new ArrowAction());
    }
    ...
    public void createUnitPatterns() {
        ...
        Stats archerStats = new Stats(1, 5, 10, 10, 1, 5, 0.5f, 0.5f, 2f, 0.2f, 5.0f);
        ...
        archer.getActions().add(actions.get(2));
