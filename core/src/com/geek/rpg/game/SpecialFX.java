...
public class SpecialFX {
    ...
    public void setup(SpecialFXType type, float xFrom, float yFrom, float xTo, float yTo, float maxTime, float scaleFrom, float scaleTo, float delay, boolean oneCycle) {
        if (type == SpecialFXType.EXPLOSION) {
            maxFrames = 64;
        ...
        } else if (type == SpecialFXType.ARROW) {
            maxFrames = 1;
